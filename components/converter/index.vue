<template>
    <div class="w-full max-w-[432px]">
        <app-input v-model="token" @select-token="isSelectTokenModalShow = true" />
        ...
        <app-input v-model="token" class="mb-6" @select-token="isSelectTokenModalShow = true" />
    ...
    <app-modal v-model="isSelectTokenModalShow">
        <assets-dialog @close-dialog="isSelectTokenModalShow = false" />
    </app-modal>
</template>
